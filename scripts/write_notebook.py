"""Helper script — regenerates the Colab notebook with valid JSON."""
import json, pathlib
...
cells = [
    ...
    # ── Cell 1 ────────────────────────────────────────────────────────────────
    md("## Cell 1 — Detect Hardware & Install Dependencies"),
    code([
        "import os, torch\n",
        "\n",
        "# Detect GPU\n",
    ...
    md(
        ...
        "Effective batch size: 16 per device. `bf16=True` is supported natively "
        "on A100 for speed. Estimated time: **~10–15 min**."
    ),
    code([
        "import json\n",
    ...
    # ── Cell 7 ────────────────────────────────────────────────────────────────
    md("## Cell 7 — Full-Dataset Inference"),
    code([
...
print(f"Notebook written and JSON-validated OK: {OUT}")
